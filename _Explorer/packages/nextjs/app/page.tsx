...
export default function Home() {
  ...
  // Driving the entire animation based on the container's scroll position
  ...
  return (
    /* 🚨 THE TRACK: Defines the total scroll length (450dvh for mobile safety) */
    <div ref={containerRef} className="relative h-[450dvh] bg-[#0a0f16] text-base-content">
      
      /* 🚨 THE STICKY STAGE: This stays pinned to the viewport */
      <div className="sticky top-0 h-[100dvh] w-full flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-24 z-50 text-center px-5 w-full flex justify-center pointer-events-none">
          ...
          <motion.div style={{ opacity: text3Opacity }} className="absolute">
            <h1 className="text-3xl md:text-5xl font-bold text-success mb-2">Minting sXRP</h1>
          ...
          <motion.div style={{ opacity: text4Opacity }} className="absolute">
            <h1 className="text-3xl md:text-5xl font-bold text-warning mb-2">Injecting HXT</h1>
          ...
          <motion.div style={{ opacity: text5Opacity }} className="absolute">
            <h1 className="text-3xl md:text-5xl font-bold text-primary mb-2">Bridge Complete</h1>
        ...
        <div className="relative w-full max-w-4xl h-[400px] z-10 flex items-center justify-center mt-10 pointer-events-none">
          ...
          <motion.div 
            ...
            className="absolute z-20 w-20 h-20 bg-base-300/50 rounded-2xl border border-success/30 flex items-center justify-center backdrop-blur-sm left-[10%]"
          >
        ...
        >
          {/* 🚨 NAVIGATION: Wrapped in Link to go to Explorer */}
          <Link href="/explorer">
